...
with col3:
    ...
    st.metric(label="Temperature", value= "{}°C".format(tiempo_madrid['current']['humidity']), delta = "{}°C".format(round(tiempo_madrid['current']['humidity'] - tiempo_anterior['forecast']['forecastday'][0]['day']['humidity'],1)))
